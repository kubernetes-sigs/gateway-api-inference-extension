...
func (in *CapacityLimits) DeepCopyInto(out *CapacityLimits) {
	*out = *in
	if in.MaxBytes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityLimits.
func (in *CapacityLimits) DeepCopy() *CapacityLimits {
	if in == nil {
		return nil
	}
	out := new(CapacityLimits)
	in.DeepCopyInto(out)
	return out
}
