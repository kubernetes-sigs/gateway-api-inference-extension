	...
	req1 := &fwksched.InferenceRequest{
		...
		Body: &requesthandle.InferenceRequestBody{
			Completions: &requesthandle.CompletionsRequest{
				Prompt: requesthandle.Prompt{Raw: "aaaabbbb"},
			},
		},
	}
...
func TestPrefixPluginCompletion(t *testing.T) {
	...
	req1 := &fwksched.InferenceRequest{
		...
		Body: &requesthandle.InferenceRequestBody{
			Completions: &requesthandle.CompletionsRequest{
				Prompt: requesthandle.Prompt{Raw: "aaaaaa"},
			},
		},
	}
		...
		Body: &requesthandle.InferenceRequestBody{
			ChatCompletions: &requesthandle.ChatCompletionsRequest{
				Messages: []requesthandle.Message{
					...
					{Role: "user", Content: requesthandle.Content{Raw: "Hello, how are you?"}},
				},
			},
		},
	}
		...
		Body: &requesthandle.InferenceRequestBody{
			ChatCompletions: &requesthandle.ChatCompletionsRequest{
				Messages: []requesthandle.Message{
					{Role: "system", Content: requesthandle.Content{Raw: "You are a helpful assistant"}},
					{Role: "user", Content: requesthandle.Content{Raw: "Hello, how are you?"}},
					{Role: "assistant", Content: requesthandle.Content{Raw: "I'm doing well, thank you! How can I help you today?"}},
					{Role: "user", Content: requesthandle.Content{Raw: "Can you explain how prefix caching works?"}},
				},
			},
		},
	}
	...
	req := &fwksched.InferenceRequest{
		...
		Body: &requesthandle.InferenceRequestBody{
			Completions: &requesthandle.CompletionsRequest{
				...
				Prompt: requesthandle.Prompt{Raw: strings.Repeat("a", 128)},
			},
		},
	}
	...
	for _, v := range promptLen {
		b.Run(fmt.Sprintf("length_%d", v), func(b *testing.B) {
			...
			req := &fwksched.InferenceRequest{
				...
				Body: &requesthandle.InferenceRequestBody{
					Completions: &requesthandle.CompletionsRequest{
						Prompt: requesthandle.Prompt{Raw: prompt},
					},
				},
			}
