...
func (h *SingleProfileHandler) Pick(_ context.Context, _ *framework.CycleState, request *requesthandling.InferenceRequest, profiles map[string]framework.SchedulerProfile,
...
func (h *SingleProfileHandler) ProcessResults(_ context.Context, _ *framework.CycleState, _ *requesthandling.InferenceRequest,
