...
| `inferenceExtension.baseModel`                             | Base model used in the current instance of the epp. When this flag is set the HttpRoute will be set to match the pool based on `X-Gateway-Base-Model-Name` header. Optional.                                                                                                                                                                       |
