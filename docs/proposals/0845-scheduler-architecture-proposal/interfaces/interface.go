...
type Filter interface {
	Plugin
	Filter(ctx context.Context, request *Request, state *CycleState, endpoints []*Endpoint) []*Endpoint
}
...
type Scorer interface {
	Plugin
	Score(ctx context.Context, request *Request, state *CycleState, endpoints []*Endpoint) []*ScoredEndpoint
}
...
type Picker interface {
	Plugin
	Pick(ctx context.Context, state *CycleState, endpoints []*ScoredEndpoint) []*ScoredEndpoint
}
