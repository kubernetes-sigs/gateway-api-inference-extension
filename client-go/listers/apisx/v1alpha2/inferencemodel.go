...
type InferenceModelLister interface {
	...
	List(selector labels.Selector) (ret []*apisxv1alpha2.InferenceModel, err error)
...
type inferenceModelLister struct {
	listers.ResourceIndexer[*apisxv1alpha2.InferenceModel]
}
...
func NewInferenceModelLister(indexer cache.Indexer) InferenceModelLister {
	return &inferenceModelLister{listers.New[*apisxv1alpha2.InferenceModel](indexer, apisxv1alpha2.Resource("inferencemodel"))}
}

// InferenceModels returns an object that can list and get InferenceModels.
func (s *inferenceModelLister) InferenceModels(namespace string) InferenceModelNamespaceLister {
	return inferenceModelNamespaceLister{listers.NewNamespaced[*apisxv1alpha2.InferenceModel](s.ResourceIndexer, namespace)}
}
...
type InferenceModelNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisxv1alpha2.InferenceModel, error)
