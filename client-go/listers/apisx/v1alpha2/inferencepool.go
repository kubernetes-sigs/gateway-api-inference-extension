...
type InferencePoolLister interface {
	...
	List(selector labels.Selector) (ret []*apisxv1alpha2.InferencePool, err error)
...
type inferencePoolLister struct {
	listers.ResourceIndexer[*apisxv1alpha2.InferencePool]
}
...
func NewInferencePoolLister(indexer cache.Indexer) InferencePoolLister {
	return &inferencePoolLister{listers.New[*apisxv1alpha2.InferencePool](indexer, apisxv1alpha2.Resource("inferencepool"))}
}

// InferencePools returns an object that can list and get InferencePools.
func (s *inferencePoolLister) InferencePools(namespace string) InferencePoolNamespaceLister {
	return inferencePoolNamespaceLister{listers.NewNamespaced[*apisxv1alpha2.InferencePool](s.ResourceIndexer, namespace)}
}
...
type InferencePoolNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisxv1alpha2.InferencePool, error)
