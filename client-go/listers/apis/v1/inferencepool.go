...
type InferencePoolLister interface {
	...
	List(selector labels.Selector) (ret []*apisv1.InferencePool, err error)
...
type inferencePoolLister struct {
	listers.ResourceIndexer[*apisv1.InferencePool]
}
...
func NewInferencePoolLister(indexer cache.Indexer) InferencePoolLister {
	return &inferencePoolLister{listers.New[*apisv1.InferencePool](indexer, apisv1.Resource("inferencepool"))}
}

// InferencePools returns an object that can list and get InferencePools.
func (s *inferencePoolLister) InferencePools(namespace string) InferencePoolNamespaceLister {
	return inferencePoolNamespaceLister{listers.NewNamespaced[*apisv1.InferencePool](s.ResourceIndexer, namespace)}
}
...
type InferencePoolNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv1.InferencePool, error)
