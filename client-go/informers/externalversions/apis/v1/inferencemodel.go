...
import (
	...
	gatewayapiinferenceextensionapisv1 "sigs.k8s.io/gateway-api-inference-extension/apis/v1"
	...
	apisv1 "sigs.k8s.io/gateway-api-inference-extension/client-go/listers/apis/v1"
)
...
type InferenceModelInformer interface {
	...
	Lister() apisv1.InferenceModelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InferenceV1().InferenceModels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InferenceV1().InferenceModels(namespace).Watch(context.TODO(), options)
			},
		},
		&gatewayapiinferenceextensionapisv1.InferenceModel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferenceModelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiinferenceextensionapisv1.InferenceModel{}, f.defaultInformer)
}

func (f *inferenceModelInformer) Lister() apisv1.InferenceModelLister {
	return apisv1.NewInferenceModelLister(f.Informer().GetIndexer())
}
