...
type InferencePoolInformer interface {
	...
	Lister() apisv1.InferencePoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.InferenceV1().InferencePools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InferenceV1().InferencePools(namespace).Watch(context.TODO(), options)
			},
		},
		&gatewayapiinferenceextensionapisv1.InferencePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferencePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiinferenceextensionapisv1.InferencePool{}, f.defaultInformer)
}

func (f *inferencePoolInformer) Lister() apisv1.InferencePoolLister {
	return apisv1.NewInferencePoolLister(f.Informer().GetIndexer())
}
