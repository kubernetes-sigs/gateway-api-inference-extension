...
import (
	...
	gatewayapiinferenceextensionapisxv1alpha2 "sigs.k8s.io/gateway-api-inference-extension/apisx/v1alpha2"
	...
	apisxv1alpha2 "sigs.k8s.io/gateway-api-inference-extension/client-go/listers/apisx/v1alpha2"
)
...
type InferenceModelInformer interface {
	...
	Lister() apisxv1alpha2.InferenceModelLister
}
...
func NewFilteredInferenceModelInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&gatewayapiinferenceextensionapisxv1alpha2.InferenceModel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferenceModelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiinferenceextensionapisxv1alpha2.InferenceModel{}, f.defaultInformer)
}

func (f *inferenceModelInformer) Lister() apisxv1alpha2.InferenceModelLister {
	return apisxv1alpha2.NewInferenceModelLister(f.Informer().GetIndexer())
}
