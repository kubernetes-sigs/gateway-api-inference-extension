...
type InferencePoolInformer interface {
	...
	Lister() apisxv1alpha2.InferencePoolLister
}
...
func NewFilteredInferencePoolInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&gatewayapiinferenceextensionapisxv1alpha2.InferencePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferencePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiinferenceextensionapisxv1alpha2.InferencePool{}, f.defaultInformer)
}

func (f *inferencePoolInformer) Lister() apisxv1alpha2.InferencePoolLister {
	return apisxv1alpha2.NewInferencePoolLister(f.Informer().GetIndexer())
}
