...
type LabelSelectorRequirementApplyConfiguration struct {
	Key      *apixv1alpha2.LabelKey              `json:"key,omitempty"`
	Operator *apixv1alpha2.LabelSelectorOperator `json:"operator,omitempty"`
	Values   []apixv1alpha2.LabelValue           `json:"values,omitempty"`
}
...
func (b *LabelSelectorRequirementApplyConfiguration) WithKey(value apixv1alpha2.LabelKey) *LabelSelectorRequirementApplyConfiguration {
	b.Key = &value
	return b
}
...
func (b *LabelSelectorRequirementApplyConfiguration) WithOperator(value apixv1alpha2.LabelSelectorOperator) *LabelSelectorRequirementApplyConfiguration {
	b.Operator = &value
	return b
}
...
func (b *LabelSelectorRequirementApplyConfiguration) WithValues(values ...apixv1alpha2.LabelValue) *LabelSelectorRequirementApplyConfiguration {
	for i := range values {
