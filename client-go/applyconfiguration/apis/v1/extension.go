...
func (b *ExtensionApplyConfiguration) WithGroup(value apisv1.Group) *ExtensionApplyConfiguration {
...
func (b *ExtensionApplyConfiguration) WithKind(value apisv1.Kind) *ExtensionApplyConfiguration {
...
func (b *ExtensionApplyConfiguration) WithName(value apisv1.ObjectName) *ExtensionApplyConfiguration {
...
func (b *ExtensionApplyConfiguration) WithPortNumber(value apisv1.PortNumber) *ExtensionApplyConfiguration {
...
func (b *ExtensionApplyConfiguration) WithFailureMode(value apisv1.ExtensionFailureMode) *ExtensionApplyConfiguration {
