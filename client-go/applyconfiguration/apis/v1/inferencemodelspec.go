...
type InferenceModelSpecApplyConfiguration struct {
	...
	Criticality  *apisv1.Criticality                    `json:"criticality,omitempty"`
...
func (b *InferenceModelSpecApplyConfiguration) WithCriticality(value apisv1.Criticality) *InferenceModelSpecApplyConfiguration {
	b.Criticality = &value
	return b
}
