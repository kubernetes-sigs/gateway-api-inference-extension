...
type ExtensionReferenceApplyConfiguration struct {
	...
	PortNumber *apisv1.PortNumber `json:"portNumber,omitempty"`
}
...
func (b *ExtensionReferenceApplyConfiguration) WithGroup(value apisv1.Group) *ExtensionReferenceApplyConfiguration {
	b.Group = &value
	return b
}
...
func (b *ExtensionReferenceApplyConfiguration) WithKind(value apisv1.Kind) *ExtensionReferenceApplyConfiguration {
	b.Kind = &value
	return b
}
...
func (b *ExtensionReferenceApplyConfiguration) WithName(value apisv1.ObjectName) *ExtensionReferenceApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *ExtensionReferenceApplyConfiguration) WithPortNumber(value apisv1.PortNumber) *ExtensionReferenceApplyConfiguration {
	b.PortNumber = &value
	return b
}
