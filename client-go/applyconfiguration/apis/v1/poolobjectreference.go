...
func (b *PoolObjectReferenceApplyConfiguration) WithGroup(value apisv1.Group) *PoolObjectReferenceApplyConfiguration {
	b.Group = &value
	return b
}
...
func (b *PoolObjectReferenceApplyConfiguration) WithKind(value apisv1.Kind) *PoolObjectReferenceApplyConfiguration {
	b.Kind = &value
	return b
}
...
func (b *PoolObjectReferenceApplyConfiguration) WithName(value apisv1.ObjectName) *PoolObjectReferenceApplyConfiguration {
	b.Name = &value
	return b
}
