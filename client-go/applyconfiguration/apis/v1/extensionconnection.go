...
type ExtensionConnectionApplyConfiguration struct {
	FailureMode *apisv1.ExtensionFailureMode `json:"failureMode,omitempty"`
}
...
func (b *ExtensionConnectionApplyConfiguration) WithFailureMode(value apisv1.ExtensionFailureMode) *ExtensionConnectionApplyConfiguration {
	b.FailureMode = &value
	return b
}
