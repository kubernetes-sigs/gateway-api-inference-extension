...
type InferencePoolSpecApplyConfiguration struct {
	Selector                               map[apisv1.LabelKey]apisv1.LabelValue `json:"selector,omitempty"`
...
func (b *InferencePoolSpecApplyConfiguration) WithSelector(entries map[apisv1.LabelKey]apisv1.LabelValue) *InferencePoolSpecApplyConfiguration {
	if b.Selector == nil && len(entries) > 0 {
		b.Selector = make(map[apisv1.LabelKey]apisv1.LabelValue, len(entries))
	}
