...
type InferencePoolSpecApplyConfiguration struct {
	Selector                               map[apisxv1alpha2.LabelKey]apisxv1alpha2.LabelValue `json:"selector,omitempty"`
...
func (b *InferencePoolSpecApplyConfiguration) WithSelector(entries map[apisxv1alpha2.LabelKey]apisxv1alpha2.LabelValue) *InferencePoolSpecApplyConfiguration {
	if b.Selector == nil && len(entries) > 0 {
		b.Selector = make(map[apisxv1alpha2.LabelKey]apisxv1alpha2.LabelValue, len(entries))
	}
