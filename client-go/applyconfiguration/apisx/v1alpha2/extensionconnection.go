...
type ExtensionConnectionApplyConfiguration struct {
	FailureMode *apisxv1alpha2.ExtensionFailureMode `json:"failureMode,omitempty"`
}
...
func (b *ExtensionConnectionApplyConfiguration) WithFailureMode(value apisxv1alpha2.ExtensionFailureMode) *ExtensionConnectionApplyConfiguration {
	b.FailureMode = &value
	return b
}
