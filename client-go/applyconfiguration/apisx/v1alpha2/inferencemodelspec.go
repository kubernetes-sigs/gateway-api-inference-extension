...
type InferenceModelSpecApplyConfiguration struct {
	...
	Criticality  *apisxv1alpha2.Criticality             `json:"criticality,omitempty"`
...
func (b *InferenceModelSpecApplyConfiguration) WithCriticality(value apisxv1alpha2.Criticality) *InferenceModelSpecApplyConfiguration {
	b.Criticality = &value
	return b
}
