...
func (b *ObjectReferenceApplyConfiguration) WithGroup(value apiv1.Group) *ObjectReferenceApplyConfiguration {
	b.Group = &value
	return b
}
...
func (b *ObjectReferenceApplyConfiguration) WithKind(value apiv1.Kind) *ObjectReferenceApplyConfiguration {
	b.Kind = &value
	return b
}
...
func (b *ObjectReferenceApplyConfiguration) WithName(value apiv1.ObjectName) *ObjectReferenceApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *ObjectReferenceApplyConfiguration) WithNamespace(value apiv1.Namespace) *ObjectReferenceApplyConfiguration {
	b.Namespace = &value
	return b
}
