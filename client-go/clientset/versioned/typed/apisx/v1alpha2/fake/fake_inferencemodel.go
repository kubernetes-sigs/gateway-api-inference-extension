...
import (
	...
	typedapisxv1alpha2 "sigs.k8s.io/gateway-api-inference-extension/client-go/clientset/versioned/typed/apisx/v1alpha2"
)

// fakeInferenceModels implements InferenceModelInterface
type fakeInferenceModels struct {
	*gentype.FakeClientWithListAndApply[*v1alpha2.InferenceModel, *v1alpha2.InferenceModelList, *apisxv1alpha2.InferenceModelApplyConfiguration]
	Fake *FakeInferenceV1alpha2
}

func newFakeInferenceModels(fake *FakeInferenceV1alpha2, namespace string) typedapisxv1alpha2.InferenceModelInterface {
	return &fakeInferenceModels{
		gentype.NewFakeClientWithListAndApply[*v1alpha2.InferenceModel, *v1alpha2.InferenceModelList, *apisxv1alpha2.InferenceModelApplyConfiguration](
			fake.Fake,
			namespace,
